...
* `N`: The number of individuals with reads at both SNPs
* `Neff`: An effective number of individuals. Calculated as $\sum_i 1-(1/2)^{min(d_i)}$ where $min(d_i)$ is thh minimum read depth at a SNP for individual $i$ 
